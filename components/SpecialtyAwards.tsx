...
const SpecialtyAwards: React.FC = () => {
  ...
  const getTopPlayers = (category: string, limit: number = 3) => {
    const sorted = [...playersWithStats].sort((a, b) => {
      switch (category) {
        case "spin":
          return (
            (b.beybladeStats?.spinFinishes || 0) -
            (a.beybladeStats?.spinFinishes || 0)
          );
        case "burst":
          return (
            (b.beybladeStats?.burstFinishes || 0) -
            (a.beybladeStats?.burstFinishes || 0)
          );
        case "over":
          return (
            (b.beybladeStats?.overFinishes || 0) -
            (a.beybladeStats?.overFinishes || 0)
          );
        case "extreme":
          return (
            (b.beybladeStats?.extremeFinishes || 0) -
            (a.beybladeStats?.extremeFinishes || 0)
          );
        case "total":
  ...
  const awardCategories = [
    {
      id: "spin",
      name: "Spin Finish Master",
      icon: Target,
      color: "from-blue-500 to-cyan-500",
      description: "Most spin finishes",
    },
    {
      id: "burst",
      name: "Burst Finish Specialist",
      icon: Zap,
      color: "from-orange-500 to-red-500",
      description: "Most burst finishes",
    },
    {
      id: "over",
      name: "Over Finish Expert",
      icon: TrendingUp,
      color: "from-green-500 to-emerald-500",
      description: "Most over finishes",
    },
    {
      id: "extreme",
      name: "Extreme Finish Legend",
      icon: Crown,
      color: "from-purple-500 to-pink-500",
      description: "Most extreme finishes",
    },
    {
      id: "total",
      name: "Total Finish Champion",
      icon: Medal,
      color: "from-yellow-500 to-amber-500",
      description: "Most total finishes",
    },
  ];
  ...
  if (loading) {
    return (
      <LoadingScreen message="Loading Supreme Leaderboard..." size="large" />
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {awardCategories.map((category) => {
          ...
          return (
            <div
              key={category.id}
              className="glass-card p-6 rounded-xl hover:scale-105 transition-transform duration-200"
            >
